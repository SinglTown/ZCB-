...
@implementation TCChat_LunBoScrollView
...
- (void)addTouchImageActionBlock:(void (^)(NSInteger ))block{
    __block TCChat_LunBoScrollView *men = self;
    self.block = ^(){
        if (block) {
            //多张情况
